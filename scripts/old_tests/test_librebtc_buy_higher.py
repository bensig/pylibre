#!/usr/bin/env python3
"""
Test script for LIBRE/BTC buy orders with higher BTC amounts.
This script tests buy orders with larger BTC values to see if that resolves the issue.
"""
...
def main():
    ...
    print(f"\n{'='*50}")
    print(f"Testing LIBRE/BTC Buy Orders with Higher Amounts")
    print(f"{'='*50}")
    ...
    # Test different buy order parameters with higher amounts
    test_cases = [
        # Test 1: Minimum BTC value (0.00001000 BTC) with higher price
        {"quantity": "100.0000", "price": "0.00000010", "description": "100 LIBRE @ 0.00000010 BTC (0.00001000 BTC total)"},
        
        # Test 2: Higher BTC value (0.00010000 BTC)
        {"quantity": "1000.0000", "price": "0.00000010", "description": "1000 LIBRE @ 0.00000010 BTC (0.00010000 BTC total)"},
        
        # Test 3: Even higher BTC value (0.00050000 BTC)
        {"quantity": "5000.0000", "price": "0.00000010", "description": "5000 LIBRE @ 0.00000010 BTC (0.00050000 BTC total)"},
        
        # Test 4: Maximum BTC value (0.00100000 BTC)
        {"quantity": "10000.0000", "price": "0.00000010", "description": "10000 LIBRE @ 0.00000010 BTC (0.00100000 BTC total)"},
    ]
    ...
    for result in results:
        ...
        print(f"Test {result['test_number']}: {result['description']} - {status}")
