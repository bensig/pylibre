#!/usr/bin/env python3
"""
Test script for LIBRE/BTC trading pair with the correct memo format.
...
def test_librebtc_pair(client, account):
    ...
    # Test 1: Sell 100 LIBRE at 0.0000000055 BTC (using the exact format provided)
    print("\nTest 1: Selling 100 LIBRE at 0.0000000055 BTC")
    ...
    # Test 2: Buy 1000 LIBRE at 0.0000000055 BTC
    print("\nTest 2: Buying 1000 LIBRE at 0.0000000055 BTC")
    ...
    print(f"Sell order (100 LIBRE @ 0.0000000055 BTC): {'Success' if sell_result['success'] else 'Failed'}")
    print(f"Buy order (1000 LIBRE @ 0.0000000055 BTC): {'Success' if buy_result['success'] else 'Failed'}")
